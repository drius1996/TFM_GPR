...
# Se puede observar que para el conjunto de todas las iteraciones, el valor esperado (media) es constante en todas ellas,
# y el programa no nos devuelve ningún aviso acerca de si debemos realizar más o menos iteraciones.
...
# RMSE_GP_SE <- sqrt(((Reserva_total_GP_SE-Reserva_total_observado)^2)/T_OBS);RMSE_GP_SE
# RMSE_GP_3_2 <- sqrt(((Reserva_total_GP_3_2-Reserva_total_observado)^2)/T_OBS);RMSE_GP_3_2
# RMSE_GP_5_2 <- sqrt(((Reserva_total_GP_5_2-Reserva_total_observado)^2)/T_OBS);RMSE_GP_5_2
RMSE_CL <- sqrt(((Reserva_total_CL-Reserva_total_observado)^2)/T_OBS);RMSE_CL
